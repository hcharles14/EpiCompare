...
ui<-navbarPage(
    ...
    navbarMenu(
        ...
        tabPanel('About',
            column(10,offset=1,
                HTML('
                  ...
                  <br>
                  <embed src="three_methods.pdf"  width="1000px" height="700px"/>
                  ...
                  <hr> <p>The tool can be run in Chrome, Internet Explorer, and Firefox web browser. It can be run in Safari if used in a window without other web pages. Opening other pages in the same window in Safari with the tool will make the tool disconnected from the server. </p>
                  	   <p>Because the free shiny server can only allow one user at one time, to allow multiple users to use the tool simultaneously, we created 3 copies of the tool named EpiCompare1, EpiCompare2 and EpiCompare3 and used a load balancer named EpiCompare (epigenome.wustl.edu/EpiCompare/) to assign users to the 3 copies. This allows 3 users to use the tool at one time. </p>
                  	   <p>Below lists each step of using the tool and specific requirements for each step.</p>
                  <h3> <a name="S1">4.1 Select a feature </a></h3> Select the feature for which you plan to identify the specificity. It can be enhancers or promoters defined from 15 state or 18 state ChromHMM model, histone mark H3K27ac, H3K4me1, H3K4me1, or H3K4me3. Only one feature can be chosen.  For example, use the default enhancer state from 18-state ChromHMM model here.
                  ...
                  <br>
                  <p>1.Here is a <a href="upload_test.txt" target="_blank">test file </a>. Download the file to your local drive.</p>
                  <br>
                  ...
                  <h3> <a name="S3">4.3 Select foreground samples </a></h3> Select the group of samples for which you identify specific regions. They can be chosen from Roadmap samples or uploaded samples. Click finish selection button after finishing selection. Selected sample IDs for foreground samples will be listed. For example, select 5 adult brain samples here.
        ...
        tabPanel('Publication',
            column(10,offset=1,
                HTML('
                    <p>A <a href="https://academic.oup.com/bioinformatics/article/doi/10.1093/bioinformatics/btx371/3865780/EpiCompare-An-online-tool-to-define-and-explore" target="_blank"> paper </a> about EpiCompare is pubished in Bioinformatics journal. Please cite the tool as:</p>
                    <p>Yu He, Ting Wang; EpiCompare: An online tool to define and explore genomic regions with tissue or cell type-specific epigenomic features. Bioinformatics 2017 btx371. doi: 10.1093/bioinformatics/btx371</p>
                ')
            )
        )
    ) #end of first level tabPanel
